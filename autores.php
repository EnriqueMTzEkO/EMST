...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="site-navbar bg-light">
          <div class="row align-items-center">
            <div class="col-2">
              <h2 class="mb-0 site-logo"><a href="index.html" class="font-weight-bold text-uppercase">TuManga</a></h2>
            </div>
            <div class="col-10">
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li class="active"><a href="autores.php">Autores</a>
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(images/banners/banner_contacto_c.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-5 text-center" data-aos="fade">
          <h1 class="text-uppercase">Acerca de Nosotros</h1>
          <span class="caption d-block text-white">Los miembros del equipo que trabajaron en esta página.</span>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12" data-aos="fade">
            <h2 class="site-section-heading text-center text-uppercase">Equipo de trabajo</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-6 text-center mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src="images/integrantes/persona1.jpg" alt="Image" class="img-fluid rounded w-50 mb-4">
            <h2 class="h5 text-uppercase">Alexander Martin del Campo Johnson</h2>
            <span class="d-block mb-4">Matrícula: 210805</span>
            <span class="d-block mb-4">Email: 210808@utags.edu.mx</span>
            <span class="d-block mb-4">R.I.P</span>
            <p>
          ...
          <div class="col-md-6 text-center mb-5" data-aos="fade-up" data-aos-delay="200">
            <img src="images/integrantes/persona2.jpg" alt="Image" class="img-fluid rounded w-50 mb-4">
            <h2 class="h5 text-uppercase">Rafael Ivan Reyes Fuentes</h2>
            <span class="d-block mb-4">Matrícula: 210770</span> 
            <span class="d-block mb-4">Email: 210770@utags.edu.mx</span>
            <p>
              <a href="#" class="p-3"><span class="icon-facebook"></span></a>
              <a href="#" class="p-3"><span class="icon-twitter"></span></a>
              <a href="#" class="p-3"><span class="icon-instagram"></span></a>
          ...
          <div class="col-md-6 text-center mb-5" data-aos="fade-up" data-aos-delay="300">
            <img src="images/integrantes/persona3.jpg" alt="Image" class="img-fluid rounded w-50 mb-4">
            <h2 class="h5 text-uppercase">Jesus Valdez Rivera</h2>
            <span class="d-block mb-4">Matrícula: 210808</span>
            <span class="d-block mb-4">Email: 210808@utags.edu.mx</span>
            <p>
              <a href="#" class="p-3"><span class="icon-facebook"></span></a>
              <a href="#" class="p-3"><span class="icon-instagram"></span></a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="site-section-heading mb-3 font-secondary text-uppercase">Link del Video</h2>
            <p class="mb-5"> 
